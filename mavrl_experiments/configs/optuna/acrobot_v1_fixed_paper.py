"""Fixed-allocation config for Acrobot-v1 using the original paper budgets.
...
inherited from acrobot_v1.py.

Companion to acrobot_v1_fixed.py (equal-share allocation).
"""

from mavrl_experiments.config_loader import load_optuna_config

_base = load_optuna_config("acrobot_v1")
